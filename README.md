...
const biju = {
  ...
  currentlyBuilding: "Agentic AI workflows & production LLM systems",
  education: "B.E. CSE @ Sathyabama Institute (2023-2027)",
  languages: ["TypeScript", "Python", "JavaScript"],
  stack: ["Next.js", "React", "Node.js", "Firebase", "LangChain", "FastAPI"],
  interests: ["AI/ML", "Agentic Systems", "SaaS", "LLM Fine-tuning"],
  learning: ["LLM Fine-tuning", "Cloud Infrastructure", "RAG Pipelines"],
...
|---------|-------------|-------|------|
| **MAI** | Multi-model AI chat — GPT-4, Claude & Gemini unified | TypeScript, Next.js, Prisma | [GitHub](https://github.com/bijudamian/MAI) |
| **Agentic CRM** | AI-powered CRM with autonomous workflows | Next.js, Firebase, LangChain | [Live](https://agentic-crm.vercel.app) |
| **SkillStacks** | Premium SaaS playbook platform — 500+ users | Next.js, Stripe, Firebase | [Live](https://skillstacks.vercel.app) |
| **Mileage Predictor AI** | ML app with Random Forest on Indian traffic data | Python, FastAPI, React | [Live](https://mileage-predictor.vercel.app) |
| **AI Chatbots** | RAG-based chatbots using LangChain + Gemini + NLP | Python, LangChain | [GitHub](https://github.com/bijudamian/AI-Chatbots) |
| **KidsBank** | Financial literacy game for kids | TypeScript, React | [GitHub](https://github.com/bijudamian/KidsBank) |
